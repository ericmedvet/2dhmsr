...
public class QuantizedDistributedSpikingSensingNonDirectional extends QuantizedDistributedSpikingSensing {
  ...
  public QuantizedDistributedSpikingSensingNonDirectional(Grid<Voxel> voxels, int stateSize, QuantizedSpikingFunction spikingFunction, QuantizedValueToSpikeTrainConverter valueToSpikeTrainConverter, QuantizedSpikeTrainToValueConverter spikeTrainToValueConverter) {
    this(
        stateSize,
