...
public class ImmutableVoxel extends ImmutableObject {

  private final double restArea;

  public ImmutableVoxel(Object object, Shape shape, List<ImmutableObject> children, double restArea) {
    super(object, shape, children);
